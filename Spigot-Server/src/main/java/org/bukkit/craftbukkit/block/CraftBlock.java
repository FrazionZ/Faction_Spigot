...
public class CraftBlock implements Block {
    ...
    public BlockState getState() {
        ...
        case DIRT_CHEST:
            return new CraftDirtChest(this);
        case ONYX_CHEST:
            return new CraftOnyxChest(this);
        case YELLITE_CHEST:
            return new CraftYelliteChest(this);
        case BAUXITE_CHEST:
            return new CraftBauxiteChest(this);
        case FRAZION_CHEST:
            return new CraftFrazionChest(this);
        case HDV_CHEST:
            return new CraftHdvChest(this);
            
        case LIT_YELLITE_FURNACE:
        case YELLITE_FURNACE:
            return new CraftYelliteFurnace(this);
            
        case LIT_BAUXITE_FURNACE:
        case BAUXITE_FURNACE:
            return new CraftBauxiteFurnace(this);
            
        case LIT_ONYX_FURNACE:
        case ONYX_FURNACE:
            return new CraftOnyxFurnace(this);
            
        case LIT_FRAZION_FURNACE:
        case FRAZION_FURNACE:
            return new CraftFrazionFurnace(this);
            
        case AMELIORATOR:
            return new CraftAmeliorator(this);
