    ...
    public <T extends Projectile> T launchProjectile(Class<? extends T> projectile, Vector velocity) {
        ...
        if (Snowball.class.isAssignableFrom(projectile)) {
            ...
            if (TippedArrow.class.isAssignableFrom(projectile)) {
                ...
                launch = new EntityDynamiteArrow(world, getHandle());
            }
            
            else {
                launch = new EntityTippedArrow(world, getHandle());
            }
            ((EntityArrow) launch).a(getHandle(), getHandle().pitch, getHandle().yaw, 0.0F, 2.0F, 1.0F); // ItemBow
            // ARROW01 ((EntityArrow) launch).a(getHandle(), getHandle().pitch, getHandle().yaw, 0.0F, 3.0F, 1.0F); // ItemBow
            ...
            launch = new EntityBigXp(world, getHandle());
            //((EntityProjectile) launch).a(getHandle(), getHandle().pitch, getHandle().yaw, -20.0F, 0.7F, 1.0F); // ItemExpBottle
        }
        
        else if (Dynamite.class.isAssignableFrom(projectile)) {
            launch = new EntityDynamite(world, getHandle());
            //((EntityProjectile) launch).a(getHandle(), getHandle().pitch, getHandle().yaw, -20.0F, 0.5F, 1.0F); // ItemDynamite
        }
