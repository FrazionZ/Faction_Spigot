...
public abstract class CraftEntity implements org.bukkit.entity.Entity {
    ...
    public static CraftEntity getEntity(CraftServer server, Entity entity) {
        ...
        if (entity instanceof EntityLiving) {
            ...
            // Water Animals
                ...
                // Monsters
                    ...
                    if (entity instanceof EntityZombie) {
                        ...
                        else if (entity instanceof EntityIllager) { return new CraftNewIllager(server, (EntityIllager) entity); }
        ...
        else if (entity instanceof EntityDynamiteArrow) { return new CraftDynamiteArrow(server, (EntityDynamiteArrow) entity); }
            ...
            else if (entity instanceof EntityBigXp) { return new CraftBigXp(server, (EntityBigXp) entity); }
            
            else if (entity instanceof EntityDynamite) { return new CraftDynamite(server, (EntityDynamite) entity); }
        }
        ...
        else if (entity instanceof EntityZTNTPrimed) { return new CraftZTNTPrimed(server, (EntityZTNTPrimed) entity); }
