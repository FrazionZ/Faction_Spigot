...
public class CraftInventoryPlayer extends CraftInventory implements org.bukkit.inventory.PlayerInventory, EntityEquipment {
    ...
    public ItemStack getLeggings() {
        return getItem(getSize() - 7);
    }

    public ItemStack getBoots() {
        return getItem(getSize() - 8);
    }

    public void setHelmet(ItemStack helmet) {
        setItem(getSize() - 5, helmet);
    }

    public void setChestplate(ItemStack chestplate) {
        setItem(getSize() - 6, chestplate);
    }

    public void setLeggings(ItemStack leggings) {
        setItem(getSize() - 7, leggings);
    }

    public void setBoots(ItemStack boots) {
        setItem(getSize() - 8, boots);
    }
    ...
    public ItemStack[] getTrophyContents() {
        return asCraftMirror(getInventory().trophyInventory);
    }
    ...
    public void setTrophyContents(ItemStack[] items) {
        setSlots(items, 41, getInventory().trophyInventory.size());
    }
