...
public class CraftInventory implements Inventory {
    ...
    public InventoryType getType() {
        ...
        } else if (inventory instanceof CraftHdvInventoryCustom.MinecraftInventory) {
            return ((CraftHdvInventoryCustom.MinecraftInventory) inventory).getType();
        }else if (inventory instanceof CraftSpawnerInventoryCustom.MinecraftInventory) {
            return ((CraftSpawnerInventoryCustom.MinecraftInventory) inventory).getType();
