...
import net.minecraft.server.ContainerAmeliorator;
import net.minecraft.server.ContainerAnvil;
import net.minecraft.server.ContainerBauxiteChest;
import net.minecraft.server.ContainerBauxiteFurnace;
import net.minecraft.server.ContainerBeacon;
import net.minecraft.server.ContainerBrewingStand;
import net.minecraft.server.ContainerChest;
import net.minecraft.server.ContainerDirtChest;
import net.minecraft.server.ContainerDispenser;
import net.minecraft.server.ContainerEnchantTable;
import net.minecraft.server.ContainerFrazionChest;
import net.minecraft.server.ContainerFrazionFurnace;
import net.minecraft.server.ContainerFurnace;
import net.minecraft.server.ContainerHdvChest;
import net.minecraft.server.ContainerHopper;
import net.minecraft.server.ContainerOnyxChest;
import net.minecraft.server.ContainerOnyxFurnace;
import net.minecraft.server.ContainerShulkerBox;
import net.minecraft.server.ContainerSpawnerInventory;
import net.minecraft.server.ContainerYelliteChest;
import net.minecraft.server.ContainerYelliteFurnace;
import net.minecraft.server.ContainerZHopper;
