...
public class CraftBlockProjectileSource implements BlockProjectileSource {
    ...
    public <T extends Projectile> T launchProjectile(Class<? extends T> projectile, Vector velocity) {
        ...
        if (Snowball.class.isAssignableFrom(projectile)) {
        ...
        else if (ThrownBigXp.class.isAssignableFrom(projectile)) {
            launch = new EntityBigXp(world, iposition.getX(), iposition.getY(), iposition.getZ());
        }
        
        
        else if (Dynamite.class.isAssignableFrom(projectile)) {
            launch = new EntityDynamite(world, iposition.getX(), iposition.getY(), iposition.getZ());
        }
            ...
            else if (DynamiteArrow.class.isAssignableFrom(projectile)) {
                launch = new EntityDynamiteArrow(world, iposition.getX(), iposition.getY(), iposition.getZ());
            }
            ...
            // FRAZIONZ J'AI MODIF CA 25 / 10 / 2020 ARROW01 //
            //((EntityArrow) launch).shoot(((EntityArrow) launch).motX, ((EntityArrow) launch).motY, ((EntityArrow) launch).motZ, 1.0F * 1.5F, 1.0F);
        ...
        if (launch instanceof IProjectile) {
            ...
            float a = 6.0F;
            float b = 1.1F;
            if (launch instanceof EntityPotion || launch instanceof ThrownExpBottle || launch instanceof ThrownBigXp) {
