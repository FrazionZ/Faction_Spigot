...
public class SpigotWorldConfig
{
    ...
    private void hoppers()
    {
        ...
        zhopperTransfer = getInt( "ticks-per.z-hopper-transfer", 4 );
        ...
        log( "Hopper Transfer: " + zhopperTransfer + " Hopper Check: " + hopperCheck + " Hopper Amount: " + hopperAmount );
    }
    ...
    private void initHunger()
    {
        if ( SpigotConfig.version < 10 )
        {
            ...
            // PVP_UPDATE
            set( "hunger.combat-exhaustion", 0.3 );
    ...
    public boolean removeOcean;
    private void removeOcean()
    {
    	removeOcean = getBoolean("remove-ocean", false);
    }
}
