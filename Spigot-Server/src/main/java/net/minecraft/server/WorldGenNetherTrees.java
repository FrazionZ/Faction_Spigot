...
public class WorldGenNetherTrees extends WorldGenTreeAbstract {
    ...
    public WorldGenNetherTrees(boolean flag) {
        this(flag, 5, WorldGenNetherTrees.a, WorldGenNetherTrees.b, false);
    }

    public WorldGenNetherTrees(boolean flag, int i, IBlockData iblockdata, IBlockData iblockdata1, boolean flag1) {
        super(flag);
        this.c = i;
        this.e = iblockdata;
        this.f = iblockdata1;
    ...
    public boolean generate(World world, Random random, BlockPosition blockposition) {
        ...
        if (blockposition.getY() >= 1 && blockposition.getY() + i + 1 <= 256) {
            ...
            if (!flag) {
                ...
                if ((block == Blocks.GRASS || block == Blocks.DIRT || block == Blocks.FARMLAND || block == Blocks.NETHERRACK) && blockposition.getY() < 256 - i - 1) {
