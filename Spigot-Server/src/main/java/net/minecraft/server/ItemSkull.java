...
public class ItemSkull extends Item {
    ...
    private static final String[] a = new String[] { "skeleton", "wither", "zombie", "char", "creeper", "dragon", "frazionz"};
                ...
                if (world.isClientSide) {
                    ...
                    if (tileentity instanceof TileEntitySkull) {
                        ...
                        if (itemstack.getData() == 3) {
                            ...
                            tileentityskull.setGameProfile(gameprofile, 3);
                        }
                        else if (itemstack.getData() == 6) {
                            GameProfile gameprofile = null;
                            ...
                            tileentityskull.setGameProfile(gameprofile, 6);
                        }
                        else {
    ...
    public String b(ItemStack itemstack) {
        ...
        else if (itemstack.getData() == 6 && itemstack.hasTag()) {
            if (itemstack.getTag().hasKeyOfType("SkullOwner", 8)) {
                return LocaleI18n.a("item.skull.player.name", new Object[] { itemstack.getTag().getString("SkullOwner")});
            }
