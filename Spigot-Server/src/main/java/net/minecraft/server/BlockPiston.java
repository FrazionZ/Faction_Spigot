...
public class BlockPiston extends BlockDirectional {
    ...
    public static boolean a(IBlockData iblockdata, World world, BlockPosition blockposition, EnumDirection enumdirection, boolean flag, EnumDirection enumdirection1) {
        ...
        if (block == Blocks.WITHER_BLOCK || block == Blocks.COMPACT_COBBLESTONE_X3 || block == Blocks.COMPACT_COBBLESTONE_X4 || block == Blocks.COMPACT_COBBLESTONE_X5 || block == Blocks.OBSIDIAN || block == Blocks.OBSIDIAN_YELLITE || block == Blocks.OBSIDIAN_BAUXITE || block == Blocks.OBSIDIAN_ONYX || block == Blocks.OBSIDIAN_FRAZION || block == Blocks.PUMPKIN || block == Blocks.MELON_BLOCK || block == Blocks.REEDS)
        {
            return false;
        }
