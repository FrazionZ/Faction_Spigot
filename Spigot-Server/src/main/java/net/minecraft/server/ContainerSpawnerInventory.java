...
public class ContainerSpawnerInventory extends Container
{
    ...
    public ContainerSpawnerInventory(IInventory playerInventory, IInventory chestInventory, EntityHuman player)
    {
        ...
        for (int j = 0; j < this.numRows; ++j)
        {
            for (int k = 0; k < 9; ++k)
            {
                this.addSlotToContainer(new Slot(chestInventory, k + j * 9, 13 + k * 18, 16 + j * 18));
            }
        }
        ...
        for (int l = 0; l < 3; ++l)
        {
            ...
            {
                this.addSlotToContainer(new Slot(playerInventory, j1 + l * 9 + 9, 13 + j1 * 18, 101 + l * 18 + i));
            }
        }

        for (int i1 = 0; i1 < 9; ++i1)
        {
            this.addSlotToContainer(new Slot(playerInventory, i1, 13 + i1 * 18, 159 + i));
        }
    }
