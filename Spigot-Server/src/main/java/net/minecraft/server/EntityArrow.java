...
public abstract class EntityArrow extends Entity implements IProjectile {
    ...
    public int h = -1; // PAIL: private->public
    public int at = -1; // PAIL: private->public
    public int au = -1; // PAIL: private->public
    private Block av;
    private int aw;
    ...
    public void a(Entity entity, float f, float f1, float f2, float velocity, float inaccuracy)
    {
    	// PVP_UPDATE
    	this.setPositionRotation(entity.locX, entity.locY + entity.getHeadHeight(), entity.locZ, entity.yaw, entity.pitch);
        ...
        this.shoot(this.motX, this.motY, this.motZ, velocity * 1.5F, 1.0f);
    ...
    public void shoot(double x, double y, double z, float velocity, float inaccuracy) {
        ...
        y /= (double) f;
        z /= (double) f;
        x += this.random.nextGaussian() * (double)(this.random.nextBoolean() ? -1 : 1) * 0.007499999832361937D * (double) inaccuracy;
        y += this.random.nextGaussian() * (double)(this.random.nextBoolean() ? -1 : 1) * 0.007499999832361937D * (double) inaccuracy;
        z += this.random.nextGaussian() * (double)(this.random.nextBoolean() ? -1 : 1) * 0.007499999832361937D * (double) inaccuracy;
        x *= (double) velocity;
        y *= (double) velocity;
        z *= (double) velocity;
        this.motX = x;
        ...
        this.yaw = (float) (MathHelper.c(x, z) * 57.2957763671875D);
        this.pitch = (float) (MathHelper.c(y, (double) f1) * 57.2957763671875D);
