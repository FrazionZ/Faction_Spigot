...
public abstract class EntityInsentient extends EntityLiving {
    ...
    private final NonNullList<ItemStack> trophyInventory;
    ...
    public ItemStack getEquipment(EnumItemSlot enumitemslot) {
        ...
        case TROPHY:
            return (ItemStack) this.trophyInventory.get(enumitemslot.b());
    ...
    public void setSlot(EnumItemSlot enumitemslot, ItemStack itemstack) {
        switch (enumitemslot.a()) {
	        ...
	        case TROPHY:
	        	this.trophyInventory.set(enumitemslot.b(), itemstack);
	        	break;
        }
    ...
    public NonNullList<ItemStack> getTrophyInventory() {
