...
public class SlotFrazionFurnaceResult extends Slot {

    private final EntityHuman a;
    private int b;

    public SlotFrazionFurnaceResult(EntityHuman entityhuman, IInventory iinventory, int i, int j, int k) {
    ...
    protected void c(ItemStack itemstack) {
        ...
        if (!this.a.world.isClientSide) {
            ...
            TileEntityFrazionFurnace furnace = ((TileEntityFrazionFurnace) this.inventory);
