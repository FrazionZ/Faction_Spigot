...
public class EntityWither extends EntityMonster implements IRangedEntity {
    ...
    public static boolean a(Block block) {
        return block != Blocks.WITHER_BLOCK && block != Blocks.COMPACT_COBBLESTONE_X5 && block != Blocks.BEDROCK && block != Blocks.FRAZION_FURNACE && block != Blocks.LIT_FRAZION_FURNACE && block != Blocks.FRAZION_CHEST && block != Blocks.OBSIDIAN_ONYX && block != Blocks.OBSIDIAN_FRAZION && block != Blocks.END_PORTAL && block != Blocks.END_PORTAL_FRAME && block != Blocks.COMMAND_BLOCK && block != Blocks.dc && block != Blocks.dd && block != Blocks.BARRIER && block != Blocks.STRUCTURE_BLOCK && block != Blocks.dj && block != Blocks.PISTON_EXTENSION && block != Blocks.END_GATEWAY;
    }
