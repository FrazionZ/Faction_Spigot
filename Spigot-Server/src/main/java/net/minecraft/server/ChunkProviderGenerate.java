...
public class ChunkProviderGenerate implements ChunkGenerator {
    ...
    public ChunkProviderGenerate(World world, long i, boolean flag, String s) {
    	this.spigotConfig = new org.spigotmc.SpigotWorldConfig( world.getWorld().getName() );
    ...
    public Chunk getOrCreateChunk(int i, int j) {
        ...
        if (this.o) {
            ...
            if (this.s.y && !this.spigotConfig.removeOcean) {
    ...
    public boolean a(World world, String s, BlockPosition blockposition) {
        return !this.o ? false : ("Stronghold".equals(s) && this.w != null ? this.w.b(blockposition) : ("Mansion".equals(s) && this.C != null ? this.C.b(blockposition) : ("Monument".equals(s) && this.B != null ? this.B.b(blockposition) : ("Village".equals(s) && this.x != null ? this.x.b(blockposition) : ("Temple".equals(s) && this.z != null ? this.z.b(blockposition) : false)))));
    }

    @Nullable
    public BlockPosition findNearestMapFeature(World world, String s, BlockPosition blockposition, boolean flag) {
        return !this.o ? null : ("Stronghold".equals(s) && this.w != null ? this.w.getNearestGeneratedFeature(world, blockposition, flag) : ("Mansion".equals(s) && this.C != null ? this.C.getNearestGeneratedFeature(world, blockposition, flag) : ("Monument".equals(s) && this.B != null ? this.B.getNearestGeneratedFeature(world, blockposition, flag) : ("Village".equals(s) && this.x != null ? this.x.getNearestGeneratedFeature(world, blockposition, flag) : ("Temple".equals(s) && this.z != null ? this.z.getNearestGeneratedFeature(world, blockposition, flag) : null)))));
    }
