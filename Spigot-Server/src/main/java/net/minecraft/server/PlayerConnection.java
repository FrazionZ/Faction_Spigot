...
public class PlayerConnection implements PacketListenerPlayIn, ITickable {
    ...
    public void a(PacketPlayInSetCreativeSlot packetplayinsetcreativeslot) {
    	...
    	org.bukkit.craftbukkit.entity.CraftPlayer playerCoco = (CraftPlayer) this.player.getBukkitEntity();
        ...
        if (this.player.playerInteractManager.isCreative()) {
            ...
            if (!itemstack.isEmpty() && itemstack.hasTag() && itemstack.getTag().hasKeyOfType("BlockEntityTag", 10)) {
                ...
                boolean flag1 = packetplayinsetcreativeslot.a() >= 1 && packetplayinsetcreativeslot.a() <= 48;
                ...
                if (flag || (flag1 && !ItemStack.matches(this.player.defaultContainer.getSlot(packetplayinsetcreativeslot.a()).getItem(), packetplayinsetcreativeslot.getItemStack()))) { // Insist on valid slot
                    ...
                    } else if (packetplayinsetcreativeslot.a() < 39) {
                        if (packetplayinsetcreativeslot.a() >= 5 && packetplayinsetcreativeslot.a() < 9) {
                            type = SlotType.ARMOR;
                        } 
                        else if (packetplayinsetcreativeslot.a() >= 9 && packetplayinsetcreativeslot.a() < 12) {
                            type = SlotType.TROPHY;
                        } else {
