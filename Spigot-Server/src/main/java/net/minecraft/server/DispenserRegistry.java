    ...
    static void b() {
        ...
        BlockDispenser.REGISTRY.a(Item.getItemOf(Blocks.Z_TNT), new DispenseBehaviorItem() {
            protected ItemStack b(ISourceBlock isourceblock, ItemStack itemstack) {
                ...
                EntityZTNTPrimed entitytntprimed = new EntityZTNTPrimed(world, event.getVelocity().getX(), event.getVelocity().getY(), event.getVelocity().getZ(), (EntityLiving) null);
                // CraftBukkit end
                    ...
                    if (!world.isClientSide) {
                        ...
                        if (tileentity instanceof TileEntitySkull) {
                            if (itemstack.getData() == 3) {
                                ...
                                ((TileEntitySkull) tileentity).setGameProfile(gameprofile, 3);
                            } else {
