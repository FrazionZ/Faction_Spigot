...
public class BlockOre extends Block {
    ...
    public Item getDropType(IBlockData iblockdata, Random random, int i) {
        return this == Blocks.COAL_ORE ? Items.COAL : (this == Blocks.FRAZION_ORE ? Items.FRAZION_POWDER : (this == Blocks.ONYX_ORE ? Items.ONYX : (this == Blocks.BAUXITE_ORE ? Items.BAUXITE : (this == Blocks.YELLITE_ORE ? Items.YELLITE : (this == Blocks.DIAMOND_ORE ? Items.DIAMOND : (this == Blocks.LAPIS_ORE ? Items.DYE : (this == Blocks.EMERALD_ORE ? Items.EMERALD : (this == Blocks.QUARTZ_ORE ? Items.QUARTZ : Item.getItemOf(this)))))))));
    }
