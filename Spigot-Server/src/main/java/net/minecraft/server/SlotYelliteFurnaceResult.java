...
public class SlotYelliteFurnaceResult extends Slot {

    private final EntityHuman a;
    private int b;

    public SlotYelliteFurnaceResult(EntityHuman entityhuman, IInventory iinventory, int i, int j, int k) {
    ...
    protected void c(ItemStack itemstack) {
        ...
        if (!this.a.world.isClientSide) {
            ...
            TileEntityYelliteFurnace furnace = ((TileEntityYelliteFurnace) this.inventory);
