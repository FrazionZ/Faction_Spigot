...
public class HandshakeListener implements PacketHandshakingInListener {
    ...
    public void a(PacketHandshakingInSetProtocol packethandshakinginsetprotocol) {
        ...
        case LOGIN:
            ...
            /*if (packethandshakinginsetprotocol.b() > 574200) {
                chatmessage = new ChatMessage( java.text.MessageFormat.format( org.spigotmc.SpigotConfig.outdatedServerMessage.replaceAll("'", "''"), "FrazionZ" ) ); // Spigot
                this.b.sendPacket(new PacketLoginOutDisconnect(chatmessage));
                this.b.close(chatmessage);
            } else if (packethandshakinginsetprotocol.b() < 574200) {
                chatmessage = new ChatMessage( java.text.MessageFormat.format( org.spigotmc.SpigotConfig.outdatedClientMessage.replaceAll("'", "''"), "FrazionZ" ) ); // Spigot
                this.b.sendPacket(new PacketLoginOutDisconnect(chatmessage));
                this.b.close(chatmessage);
            }*/
