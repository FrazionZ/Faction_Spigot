...
public class TileEntityDirtChest extends TileEntityLootable implements ITickable
{
    ...
    {
        return this.hasCustomName() ? this.o : "container.dirtchest";
    }

    public static void a(DataConverterManager dataconvertermanager)
    {
        dataconvertermanager.a(DataConverterTypes.BLOCK_ENTITY, (DataInspector) (new DataInspectorItemList(TileEntityDirtChest.class, new String[] { "Items"})));
    }
    ...
    private void a(TileEntityDirtChest tileentitydirtchest, EnumDirection enumdirection)
    {
        if (tileentitydirtchest.y())
        {
            this.adjacentChestChecked = false;
        } 
        else if (this.adjacentChestChecked)
        {
            ...
            {
	            case NORTH:
	                if (this.adjacentChestZNeg != tileentitydirtchest)
	                {
	                    this.adjacentChestChecked = false;
	                }
	            ...
	            case SOUTH:
	                if (this.adjacentChestZPos != tileentitydirtchest)
	                {
	                    this.adjacentChestChecked = false;
	                }
	            ...
	            case EAST:
	                if (this.adjacentChestXPos != tileentitydirtchest)
	                {
	                    this.adjacentChestChecked = false;
	                }
	            ...
	            case WEST:
	                if (this.adjacentChestXNeg != tileentitydirtchest)
	                {
	                    this.adjacentChestChecked = false;
	                }
            }
    ...
    public void e()
    {
        ...
        if (!this.world.isClientSide && this.numPlayersUsing != 0 && (this.ticksSinceSync + i + j + k) % 200 == 0) 
        {
            ...
            while (iterator.hasNext()) {
                ...
                if (entityhuman.activeContainer instanceof ContainerDirtChest) {
                    IInventory iinventory = ((ContainerDirtChest) entityhuman.activeContainer).e();
    ...
    {
        if (!entityhuman.isSpectator() && this.getBlock() instanceof BlockDirtChest)
        {
            --this.numPlayersUsing;
            this.world.playBlockAction(this.position, this.getBlock(), 1, this.numPlayersUsing);
            this.world.applyPhysics(this.position, this.getBlock(), false);
    ...
    public Container createContainer(PlayerInventory playerinventory, EntityHuman entityhuman) {
        this.d(entityhuman);
        return new ContainerDirtChest(playerinventory, this, entityhuman);
    }
