...
public class TileEntityYelliteFurnace extends TileEntityContainer implements ITickable, IWorldInventory {

    private static final int[] a = new int[] { 0, 1 };
    private static final int[] f = new int[] { 2, 3, 4 };
    ...
    public TileEntityYelliteFurnace() {
    ...
    public static void a(DataConverterManager dataconvertermanager) {
        dataconvertermanager.a(DataConverterTypes.BLOCK_ENTITY, (DataInspector) (new DataInspectorItemList(TileEntityYelliteFurnace.class, new String[] { "Items"})));
    }
    ...
    public void load(NBTTagCompound nbttagcompound) {
        ...
        this.ticksForCurrentFuel = fuelTime((ItemStack) this.items.get(2));
    ...
    public void e()
    {
        ...
        if (!this.world.isClientSide)
        {
            ...
            if ((this.isBurning() || (!itemstack.isEmpty() && !((ItemStack)this.items.get(0)).isEmpty()) || ( !itemstack.isEmpty() && !((ItemStack)this.items.get(1)).isEmpty())))
            {
                if (!this.isBurning() && this.canBurn())
                {
                    ...
                    if (this.isBurning())
                    {
                        ...
                        if (!itemstack.isEmpty())
                        {
                            ...
                            {
                                Item item1 = item.q();
                                this.items.set(2, item1 == null ? ItemStack.a : new ItemStack(item1));
                            }
                        }
                    }
                }
            ...
            {
                flag1 = true;
                BlockYelliteFurnace.a(this.isBurning(), this.world, this.position);
            }
        }
    ...
    private boolean canBurn()
    {
        ...
        else
        {
        	...
        	else if (itemstack.isEmpty() && itemstackA.isEmpty())
            {
                return false;
            }
            else
            {
                ...
                ItemStack itemstackA1 = (ItemStack) this.items.get(4);
                   
                if (itemstack1.isEmpty() && itemstackA1.isEmpty())
                {
                    return true;
                }
                else if (!itemstack1.doMaterialsMatch(itemstack) && !itemstackA1.doMaterialsMatch(itemstackA))
                {
                    return false;
                }
    ...
    public void burn() {
        if (this.canBurn()) {
            ...
            ItemStack itemstackA2 = (ItemStack) this.items.get(4);
           ...
           /* CraftItemStack source = CraftItemStack.asCraftMirror(itemstack);
            ...
            {
                this.items.set(4, itemstackA1.cloneItemStack());
    ...
    {
        if (enumdirection == EnumDirection.DOWN && i == 2)
        {
            Item item = itemstack.getItem();
    ...
    public Container createContainer(PlayerInventory playerinventory, EntityHuman entityhuman) {
        return new ContainerYelliteFurnace(playerinventory, this);
    }
