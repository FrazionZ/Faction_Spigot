...
public class BlockYelliteChest extends BlockTileEntity implements FzExplosionBlockType {

    public static final BlockStateDirection FACING = BlockFacingHorizontal.FACING;
    protected static final AxisAlignedBB NOT_CONNECTED_AABB = new AxisAlignedBB(0.0625D, 0.0D, 0.0625D, 0.9375D, 0.875D, 0.9375D);

    public BlockYelliteChest() {
    	
        super(Material.WOOD);
        this.w(this.blockStateList.getBlockData().set(BlockYelliteChest.FACING, EnumDirection.NORTH));
    ...
    public IBlockData f(World world, BlockPosition blockposition, IBlockData iblockdata)
    {
        ...
        if (enumdirection != null) {
            return iblockdata.set(BlockYelliteChest.FACING, enumdirection.opposite());
        } else {
            EnumDirection enumdirection2 = (EnumDirection) iblockdata.get(BlockYelliteChest.FACING);
            ...
            return iblockdata.set(BlockYelliteChest.FACING, enumdirection2);
        }
    }
    ...
    public void a(IBlockData iblockdata, World world, BlockPosition blockposition, Block block, BlockPosition blockposition1)
    {
        ...
        if (tileentity instanceof TileEntityYelliteChest)
        {
    ...
    public ITileInventory a(World world, BlockPosition blockposition, boolean flag)
    {
        ...
        {
            Object object = (TileEntityYelliteChest) tileentity;
    ...
    public TileEntity a(World world, int i) {
        return new TileEntityYelliteChest();
    }
    ...
    public int b(IBlockData iblockdata, IBlockAccess iblockaccess, BlockPosition blockposition, EnumDirection enumdirection)
    {
        ...
        else
        {
            ...
            if (tileentity instanceof TileEntityYelliteChest)
            {
                i = ((TileEntityYelliteChest) tileentity).numPlayersUsing;
            }
    ...
    public IBlockData fromLegacyData(int i) {
        ...
        return this.getBlockData().set(BlockYelliteChest.FACING, enumdirection);
    }

    public int toLegacyData(IBlockData iblockdata) {
        return ((EnumDirection) iblockdata.get(BlockYelliteChest.FACING)).a();
    }

    public IBlockData a(IBlockData iblockdata, EnumBlockRotation enumblockrotation) {
        return iblockdata.set(BlockYelliteChest.FACING, enumblockrotation.a((EnumDirection) iblockdata.get(BlockYelliteChest.FACING)));
    }

    public IBlockData a(IBlockData iblockdata, EnumBlockMirror enumblockmirror) {
        return iblockdata.a(enumblockmirror.a((EnumDirection) iblockdata.get(BlockYelliteChest.FACING)));
    }

    protected BlockStateList getStateList() {
        return new BlockStateList(this, new IBlockState[] { BlockYelliteChest.FACING});
    }
	...
	public ExplosionBlockType getExplosionBlockType() {
		return ExplosionBlockType.CHEST_YELLITE;
	}
