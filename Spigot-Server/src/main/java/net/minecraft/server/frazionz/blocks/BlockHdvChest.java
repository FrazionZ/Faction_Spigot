...
public class BlockHdvChest extends BlockTileEntity {
    ...
    public BlockHdvChest() {
    	
        super(Material.WOOD);
        this.w(this.blockStateList.getBlockData().set(BlockHdvChest.FACING, EnumDirection.NORTH));
    ...
    public void postPlace(World world, BlockPosition blockposition, IBlockData iblockdata, EntityLiving entityliving, ItemStack itemstack)
    {
        ...
        iblockdata = iblockdata.set(BlockHdvChest.FACING, enumdirection);
        ...
        if (itemstack.hasName()) {
            ...
            if (tileentity instanceof TileEntityHdvChest) {
                ((TileEntityHdvChest) tileentity).setCustomName(itemstack.getName());
            }
        }
    ...
    public IBlockData f(World world, BlockPosition blockposition, IBlockData iblockdata)
    {
        ...
        if (enumdirection != null) {
            return iblockdata.set(BlockHdvChest.FACING, enumdirection.opposite());
        } else {
            EnumDirection enumdirection2 = (EnumDirection) iblockdata.get(BlockHdvChest.FACING);
            ...
            return iblockdata.set(BlockHdvChest.FACING, enumdirection2);
        }
    }
    ...
    public ITileInventory a(World world, BlockPosition blockposition, boolean flag)
    {
        ...
        {
            Object object = (TileEntityHdvChest) tileentity;
    ...
    public int b(IBlockData iblockdata, IBlockAccess iblockaccess, BlockPosition blockposition, EnumDirection enumdirection)
    {
        ...
        else
        {
            ...
            if (tileentity instanceof TileEntityHdvChest)
            {
                i = ((TileEntityHdvChest) tileentity).numPlayersUsing;
            }
    ...
    public IBlockData fromLegacyData(int i) {
        ...
        return this.getBlockData().set(BlockHdvChest.FACING, enumdirection);
    }

    public int toLegacyData(IBlockData iblockdata) {
        return ((EnumDirection) iblockdata.get(BlockHdvChest.FACING)).a();
    }

    public IBlockData a(IBlockData iblockdata, EnumBlockRotation enumblockrotation) {
        return iblockdata.set(BlockHdvChest.FACING, enumblockrotation.a((EnumDirection) iblockdata.get(BlockHdvChest.FACING)));
    }

    public IBlockData a(IBlockData iblockdata, EnumBlockMirror enumblockmirror) {
        return iblockdata.a(enumblockmirror.a((EnumDirection) iblockdata.get(BlockHdvChest.FACING)));
    }

    protected BlockStateList getStateList() {
        return new BlockStateList(this, new IBlockState[] { BlockHdvChest.FACING});
    }
