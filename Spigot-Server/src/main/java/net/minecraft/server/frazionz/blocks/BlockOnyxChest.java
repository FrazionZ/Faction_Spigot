...
public class BlockOnyxChest extends BlockTileEntity {
    ...
    public BlockOnyxChest() {
        ...
        super(Material.WOOD);
        this.w(this.blockStateList.getBlockData().set(BlockOnyxChest.FACING, EnumDirection.NORTH));
    ...
    public IBlockData f(World world, BlockPosition blockposition, IBlockData iblockdata)
    {
        ...
        if (enumdirection != null) {
            return iblockdata.set(BlockOnyxChest.FACING, enumdirection.opposite());
        } else {
            EnumDirection enumdirection2 = (EnumDirection) iblockdata.get(BlockOnyxChest.FACING);
            ...
            return iblockdata.set(BlockOnyxChest.FACING, enumdirection2);
        }
    }
    ...
    public ITileInventory a(World world, BlockPosition blockposition, boolean flag)
    {
        ...
        {
            Object object = (TileEntityOnyxChest) tileentity;
    ...
    public IBlockData fromLegacyData(int i) {
        ...
        return this.getBlockData().set(BlockOnyxChest.FACING, enumdirection);
    }

    public int toLegacyData(IBlockData iblockdata) {
        return ((EnumDirection) iblockdata.get(BlockOnyxChest.FACING)).a();
    }

    public IBlockData a(IBlockData iblockdata, EnumBlockRotation enumblockrotation) {
        return iblockdata.set(BlockOnyxChest.FACING, enumblockrotation.a((EnumDirection) iblockdata.get(BlockOnyxChest.FACING)));
    }

    public IBlockData a(IBlockData iblockdata, EnumBlockMirror enumblockmirror) {
        return iblockdata.a(enumblockmirror.a((EnumDirection) iblockdata.get(BlockOnyxChest.FACING)));
    }

    protected BlockStateList getStateList() {
        return new BlockStateList(this, new IBlockState[] { BlockOnyxChest.FACING});
    }
