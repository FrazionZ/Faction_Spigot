...
public class BlockBauxiteChest extends BlockTileEntity implements FzExplosionBlockType {
    ...
    public BlockBauxiteChest() {
    	
        super(Material.WOOD);
        this.w(this.blockStateList.getBlockData().set(BlockBauxiteChest.FACING, EnumDirection.NORTH));
    ...
    public IBlockData f(World world, BlockPosition blockposition, IBlockData iblockdata)
    {
        ...
        if (enumdirection != null) {
            return iblockdata.set(BlockBauxiteChest.FACING, enumdirection.opposite());
        } else {
            EnumDirection enumdirection2 = (EnumDirection) iblockdata.get(BlockBauxiteChest.FACING);
            ...
            return iblockdata.set(BlockBauxiteChest.FACING, enumdirection2);
        }
    }
    ...
    public void a(IBlockData iblockdata, World world, BlockPosition blockposition, Block block, BlockPosition blockposition1)
    {
        ...
        if (tileentity instanceof TileEntityBauxiteChest)
        {
    ...
    public ITileInventory a(World world, BlockPosition blockposition, boolean flag)
    {
        ...
        {
            Object object = (TileEntityBauxiteChest) tileentity;
    ...
    public TileEntity a(World world, int i) {
        return new TileEntityBauxiteChest();
    }
    ...
    public int b(IBlockData iblockdata, IBlockAccess iblockaccess, BlockPosition blockposition, EnumDirection enumdirection)
    {
        ...
        else
        {
            ...
            if (tileentity instanceof TileEntityBauxiteChest)
            {
                i = ((TileEntityBauxiteChest) tileentity).numPlayersUsing;
            }
    ...
    public IBlockData fromLegacyData(int i) {
        ...
        return this.getBlockData().set(BlockBauxiteChest.FACING, enumdirection);
    }

    public int toLegacyData(IBlockData iblockdata) {
        return ((EnumDirection) iblockdata.get(BlockBauxiteChest.FACING)).a();
    }

    public IBlockData a(IBlockData iblockdata, EnumBlockRotation enumblockrotation) {
        return iblockdata.set(BlockBauxiteChest.FACING, enumblockrotation.a((EnumDirection) iblockdata.get(BlockBauxiteChest.FACING)));
    }

    public IBlockData a(IBlockData iblockdata, EnumBlockMirror enumblockmirror) {
        return iblockdata.a(enumblockmirror.a((EnumDirection) iblockdata.get(BlockBauxiteChest.FACING)));
    }

    protected BlockStateList getStateList() {
        return new BlockStateList(this, new IBlockState[] { BlockBauxiteChest.FACING});
    }
