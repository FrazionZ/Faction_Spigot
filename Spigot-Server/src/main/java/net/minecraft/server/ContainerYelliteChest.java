...
public class ContainerYelliteChest extends Container
{
    ...
    public ContainerYelliteChest(IInventory playerInventory, IInventory chestInventory, EntityHuman player)
    {
