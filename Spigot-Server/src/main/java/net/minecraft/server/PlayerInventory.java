...
public class PlayerInventory implements IInventory {
    ...
    public final NonNullList<ItemStack> trophyInventory;
    ...
    public List<ItemStack> getContents() {
        List<ItemStack> combined = new ArrayList<ItemStack>(items.size() + armor.size() + extraSlots.size() + trophyInventory.size());
    ...
    public NonNullList<ItemStack> getTrophyContents() {
    ...
    public PlayerInventory(EntityHuman entityhuman) {
        ...
        this.trophyInventory = NonNullList.a(3, ItemStack.a);
        this.f = Arrays.asList(new NonNullList[] { this.items, this.armor, this.extraSlots, this.trophyInventory});
    ...
    public NBTTagList a(NBTTagList nbttaglist) {
        ...
        for (i = 0; i < this.trophyInventory.size(); ++i) {
            if (!((ItemStack) this.trophyInventory.get(i)).isEmpty()) {
                nbttagcompound = new NBTTagCompound();
                nbttagcompound.setByte("Slot", (byte) (i + 200));
                ((ItemStack) this.trophyInventory.get(i)).save(nbttagcompound);
                nbttaglist.add(nbttagcompound);
            }
        }
    ...
    public void b(NBTTagList nbttaglist) {
        ...
        for (int i = 0; i < nbttaglist.size(); ++i) {
            ...
            if (!itemstack.isEmpty()) {
                ...
                else if (j >= 200 && j < this.trophyInventory.size() + 200) {
                    this.trophyInventory.set(j - 200, itemstack);
                }
            }
        }
    ...
    public int getSize() {
        return this.items.size() + this.armor.size() + this.extraSlots.size() + this.trophyInventory.size();
    }
            ...
            if (!iterator.hasNext()) {
                ...
                do {
                    if (!iterator.hasNext()) {
                        ...
                        do {
                            if (!iterator.hasNext()) {
                                iterator = this.trophyInventory.iterator();
    ...
    public ItemStack getTrophyInSlot(int slot) {
    	return this.trophyInventory.get(slot);
    }
	...
	public boolean containsAtLeast(ItemStack item, int amount) {
        ...
        for (ItemStack i : this.items) {
            if (item.doMaterialsMatch(i) && ItemStack.equals(item, i) && (amount -= i.getStackSize()) <= 0) {
                return true;
            }
        }
        return false;
