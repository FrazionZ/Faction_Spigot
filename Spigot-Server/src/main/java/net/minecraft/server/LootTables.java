...
public class LootTables {
    ...
    public static final MinecraftKey ENTITIES_NETHER_SPIDER = a("entities/nether_spider");
    public static final MinecraftKey cosmicker = a("entities/cosmicker");
    
    public static final MinecraftKey BOSS_HEROBRINE_YELLOW = a("entities/herobrine_yellow");
