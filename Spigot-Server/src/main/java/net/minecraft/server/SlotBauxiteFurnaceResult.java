...
public class SlotBauxiteFurnaceResult extends Slot {

    private final EntityHuman a;
    private int b;

    public SlotBauxiteFurnaceResult(EntityHuman entityhuman, IInventory iinventory, int i, int j, int k) {
    ...
    protected void c(ItemStack itemstack) {
        ...
        if (!this.a.world.isClientSide) {
            ...
            TileEntityBauxiteFurnace furnace = ((TileEntityBauxiteFurnace) this.inventory);
