...
public class EntityPlayer extends EntityHuman implements ICrafting {
    ...
    public void addExperienceLevel(int i, boolean noSound) {
        super.addExperienceLevel(i, noSound);
        this.lastSentExp = -1;
    }
    ...
    private void applyWeaponEffect() {
		...
		ItemWeaponEffects weapon = (ItemWeaponEffects) player.getItemInMainHand().getItem();
