...
public abstract class EntityLiving extends Entity {
    ...
    private final NonNullList<ItemStack> trophyArray;
    public boolean au;
    public EnumHand av;
    public int aw;
    public int ax;
    ...
    public EntityLiving(World world) {
        ...
        this.trophyArray = NonNullList.a(3, ItemStack.a);
        this.aR = 0.02F;
        ...
        else
        {
            ...
            else
            {
                ...
                else 
                {
                    ...
                    Entity entity23 = damagesource.getEntity();
    ...
    public void e(float f, float f1) {
        ...
        if (i > 0) {
            ...
            Block block = iblockdata.getBlock();
            if(block != Blocks.REVERSE_FALL_BLOCK && this.hasEffect(MobEffectList.fromId(28))){
            	return;
            }
            // CraftBukkit start
    ...
    {
        return this.isHandRaised() && this.activeItem.getItem().f(this.activeItem) == EnumAnimation.BLOCK_SWORD;
    }
    ...
    public void a(float f, float f1, float f2) {
        ...
        if (this.cC() || this.bI()) {
            ...
            if (this.isInWater() && (!(this instanceof EntityHuman) || !((EntityHuman) this).abilities.isFlying)) {
                ...
                if (this.positionChanged && this.m_() && (block == Blocks.VINE || block == Blocks.LADDER))
                {
                    this.motY = 0.2D;
                }
                
                else if (this.positionChanged && this.m_() && (block == Blocks.YELLITE_LADDER))
                {
                    this.motY = 0.35D;
                }
                
                else if (this.positionChanged && this.m_() && (block == Blocks.BAUXITE_LADDER))
                {
                    this.motY = 0.5D;
                }
                
                else if (this.positionChanged && this.m_() && (block == Blocks.ONYX_LADDER))
                {
                    this.motY = 0.8D;
                }
                
                else if (this.positionChanged && this.m_() && (block == Blocks.FRAZION_LADDER))
                {
                    this.motY = 1.0D;
                }
    ...
    public void B_() {
        ...
        if (!this.world.isClientSide) {
            ...
            for (int k = 0; k < j; ++k) {
                ...
                case TROPHY:
                    itemstack = (ItemStack) this.trophyArray.get(enumitemslot.b());
                    break;
                ...
                if (!ItemStack.matches(itemstack1, itemstack)) {
                    ...
                    /*if(this instanceof EntityHuman) {
                        for(AttributeInstance inst : this.getAttributeMap().a()) {
                        	System.out.println("==============");
                        	System.out.println("Name : " + inst.getAttribute().getName());
                        	System.out.println("Default Value : " + inst.getAttribute().getDefault());
                        	System.out.println("Actual Value : " + inst.getValue());
                        }
                    }*/
                    ...
                    case TROPHY:
                        this.trophyArray.set(enumitemslot.b(), itemstack1.isEmpty() ? ItemStack.a : itemstack1.cloneItemStack());
                    }
                }
            }
