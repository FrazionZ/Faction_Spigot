...
public class BiomeDecorator {
    ...
    public void a(World world, Random random, BiomeBase biomebase, BlockPosition blockposition) {
        if (this.a) {
            ...
            this.yelliteGen = new WorldGenMinable(Blocks.YELLITE_ORE.getBlockData(), 8);
            this.bauxiteGen = new WorldGenMinable(Blocks.BAUXITE_ORE.getBlockData(),7);
            this.onyxGen = new WorldGenMinable(Blocks.ONYX_ORE.getBlockData(), 5);
            this.zGen = new WorldGenMinable(Blocks.FRAZION_ORE.getBlockData(), 5);
            this.randomOreGen = new WorldGenMinable(Blocks.RANDOM_ORE.getBlockData(), 5);
    ...
    protected void a(World world, Random random) {
        ...
        this.a(world, random, this.c.am, this.n, this.c.an, this.c.ao + 4);
        this.a(world, random, this.c.aq, this.o, this.c.ar, this.c.as);
        this.a(world, random, this.c.am, this.p, this.c.av, this.c.aw);
        this.b(world, random, this.c.ay, this.q, this.c.az, this.c.aA);
        
        this.a(world, random, 4, this.yelliteGen, 1, 28);
        this.a(world, random, 4, this.bauxiteGen, 1, 24);
        this.a(world, random, 3, this.onyxGen, 1, 16);
        this.a(world, random, 2, this.zGen, 2, 12);
        this.a(world, random, 3, this.randomOreGen, 1, 16);
    }
    ...
    protected void a(World world, Random random, int i, WorldGenerator worldgenerator, int j, int k) {
        ...
        for (l = 0; l < i; ++l) {
        	...
        	else if(worldgenerator == this.yelliteGen) {
            	float i1 = randomFloat.nextFloat();
            	if(i1 < 0.60F) {
                    worldgenerator.generate(world, random, blockposition);
            	}
        	}
        	else if(worldgenerator == this.randomOreGen) {
            	float i1 = randomFloat.nextFloat();
            	if(i1 < 0.45F) {
                    worldgenerator.generate(world, random, blockposition);
            	}
