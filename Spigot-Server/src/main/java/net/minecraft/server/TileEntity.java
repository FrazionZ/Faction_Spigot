...
public abstract class TileEntity {
    ...
    static {
        ...
        a("z_hopper", TileEntityZHopper.class);
        a("dirt_chest", TileEntityDirtChest.class);
        a("yellite_chest", TileEntityYelliteChest.class);
        a("bauxite_chest", TileEntityBauxiteChest.class);
        ...
        a("onyx_furnace", TileEntityOnyxFurnace.class);
        a("frazion_furnace", TileEntityFrazionFurnace.class);
