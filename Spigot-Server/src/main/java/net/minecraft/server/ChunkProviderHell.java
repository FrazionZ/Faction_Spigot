...
public class ChunkProviderHell implements ChunkGenerator
{
    ...
    protected static final IBlockData NETHERRACK_NYLIUM = Blocks.NETHERRACK.fromLegacyData(1);
    ...
    private final WorldGenerator ObsidianGen;
    ...
    public ChunkProviderHell(World world, boolean flag, long i) {
        ...
        this.ObsidianGen = new WorldGenObsidianNether(Blocks.OBSIDIAN.getBlockData(), 100, BlockPredicate.a(Blocks.LAVA) , BlockPredicate.a(Blocks.AIR));
    ...
    public void b(int i, int j, ChunkSnapshot chunksnapshot) {
        ...
        for (int l = 0; l < 16; ++l) {
            for (int i1 = 0; i1 < 16; ++i1) {
                ...
                int k1 = -1;
                IBlockData iblockdata = ChunkProviderHell.NETHERRACK_NYLIUM;
                            ...
                            if (iblockdata2.getBlock() == Blocks.NETHERRACK) {
                                if (k1 == -1) {
                                    if (j1 <= 0) {
                                        ...
                                        iblockdata = ChunkProviderHell.NETHERRACK_NYLIUM;
                                        iblockdata1 = ChunkProviderHell.b;
                                        if (flag1) {
    ...
    public void recreateStructures(int i, int j) {
        ...
        for (int o1 = 0; o1 < 18; ++o1)
        {
            this.crimson_roots.generate(this.n, this.p, blockposition.a(this.p.nextInt(16) + 8, this.p.nextInt(128), this.p.nextInt(16) + 8));
        }
        
        for (int o1 = 0; o1 < 2; ++o1)
        {
            this.crimson_fungi.generate(this.n, this.p, blockposition.a(this.p.nextInt(16) + 8, this.p.nextInt(128), this.p.nextInt(16) + 8));
        }
        ...
        for (i1 = 0; i1 < 40; ++i1) {
            this.treesGen.generate(this.n, this.p, blockposition.a(this.p.nextInt(16) + 8, this.p.nextInt(120) + 4, this.p.nextInt(16) + 8));
        }
        ...
        if(rand.nextInt(100) <= 6) {
        	...
        	for (j1 = 0; j1 < 1; ++j1) {
                this.ObsidianGen.generate(this.n, this.p, blockposition.a(this.p.nextInt(16), i1 - 5 + this.p.nextInt(6), this.p.nextInt(16)));
            }
