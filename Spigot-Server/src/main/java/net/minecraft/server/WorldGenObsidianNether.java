...
public class WorldGenObsidianNether extends WorldGenerator {

    private final IBlockData a;
    private final int b;
    private final Predicate<IBlockData> c;
    private final Predicate<IBlockData> predicate2;

    public WorldGenObsidianNether(IBlockData iblockdata, int i) {
        this(iblockdata, i, new WorldGenObsidianNether.a(null), new WorldGenObsidianNether.a(null));
    }

    public WorldGenObsidianNether(IBlockData iblockdata, int i, Predicate<IBlockData> predicate , Predicate<IBlockData> predicate2) {
        this.a = iblockdata;
        this.b = i;
        this.c = predicate;
                        ...
                        if (d12 * d12 + d13 * d13 < 1.0D) {
                            for (int j2 = l; j2 <= k1; ++j2) {
                                ...
                                if (d12 * d12 + d13 * d13 + d14 * d14 < 1.0D) {
                                    ...
                                    if (this.predicate2.apply(world.getType(blockposition1))) {
                                        world.setTypeAndData(blockposition1, this.a, 2);
                                    }
                                }
                            }
