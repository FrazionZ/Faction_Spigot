...
public class EntityTrackerEntry {
    ...
    private Packet<?> e() {
        ...
        if (this.tracker instanceof EntityPlayer) {
            ...
            else if (this.tracker instanceof EntityBigXp) {
                return new PacketPlayOutSpawnEntity(this.tracker, 100);
            }
            
            else if (this.tracker instanceof EntityDynamite) {
                return new PacketPlayOutSpawnEntity(this.tracker, 101);
            }
            
            else if (this.tracker instanceof EntityDynamiteArrow) {
                entity = ((EntityDynamiteArrow) this.tracker).shooter;
                return new PacketPlayOutSpawnEntity(this.tracker, 102, 1 + (entity == null ? this.tracker.getId() : entity.getId()));
            }
            ...
            else if (this.tracker instanceof EntityZTNTPrimed) {
                return new PacketPlayOutSpawnEntity(this.tracker, 103);
            }
