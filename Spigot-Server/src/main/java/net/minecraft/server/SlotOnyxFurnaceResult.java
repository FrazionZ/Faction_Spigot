...
public class SlotOnyxFurnaceResult extends Slot {

    private final EntityHuman a;
    private int b;

    public SlotOnyxFurnaceResult(EntityHuman entityhuman, IInventory iinventory, int i, int j, int k) {
    ...
    protected void c(ItemStack itemstack) {
        ...
        if (!this.a.world.isClientSide) {
            ...
            TileEntityOnyxFurnace furnace = ((TileEntityOnyxFurnace) this.inventory);
