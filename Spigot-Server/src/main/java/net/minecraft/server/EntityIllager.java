...
public class EntityIllager extends EntityIllagerAbstract {
    ...
    public EntityIllager(World world) {
        super(world);
        this.setSize(0.6F, 2.0F);
    }

    public static void a(DataConverterManager dataconvertermanager) {
        EntityInsentient.a(dataconvertermanager, EntityIllager.class);
    }
    ...
    protected void r() {
        ...
        this.targetSelector.a(1, new PathfinderGoalHurtByTarget(this, true, new Class[] { EntityIllager.class}));
        ...
        this.targetSelector.a(4, new EntityIllager.a(this));
    }

    protected void initAttributes() {
        super.initAttributes();
        this.getAttributeInstance(GenericAttributes.MOVEMENT_SPEED).setValue(0.3499999940395355D);
        this.getAttributeInstance(GenericAttributes.FOLLOW_RANGE).setValue(24.0D);
    ...
    static class a extends PathfinderGoalNearestAttackableTarget<EntityLiving> {
        ...
        public a(EntityIllager entityvindicator) {
            super(entityvindicator, EntityLiving.class, 0, true, true, EntityIllager.c);
        }

        public boolean a() {
            return ((EntityIllager) this.e).b && super.a();
        }
    }
}
