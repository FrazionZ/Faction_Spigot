...
public interface Server extends PluginMessageRecipient {
     ...
     * @return a new inventory
     */
    Inventory createHdvInventory(InventoryHolder owner, int size, String title) throws IllegalArgumentException;
     ...
     * @return a new inventory
     */
    Inventory createSpawnerInventory(InventoryHolder owner, int size, String title) throws IllegalArgumentException;
