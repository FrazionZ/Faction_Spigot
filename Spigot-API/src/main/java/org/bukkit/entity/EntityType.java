...
public enum EntityType {
    ...
    PRIMED_ZTNT("tnt", TNTPrimed.class, 217),
    /**
    ...
    NETHER_SPIDER("nether_spider", NetherSpider.class, 211),
    
    BIG_XP("big_xp", ThrownBigXp.class, 212),
    
    DYNAMITE("dynamite", Dynamite.class, 213),
    
    DYNAMITE_ARROW("dynamite_arrow", DynamiteArrow.class, 214),
    
    COSMICKER("illager", Vindicator.class, 215),
    
    HEROBRINE_1("herobrine_1", Herobrine1.class, 216),
