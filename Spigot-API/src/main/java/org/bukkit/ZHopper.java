 ...
 * @see Material#HOPPER
 */
public class ZHopper extends MaterialData implements Directional, Redstone {
     ...
     * @see BlockFace
     */
    public ZHopper(BlockFace facingDirection) {
     ...
     * @see BlockFace
     */
    public ZHopper(BlockFace facingDirection, boolean isActive) {
     ...
     */
    @Deprecated
    public ZHopper(int type) {
        super(type);
    }

    public ZHopper(Material type) {
        super(type);
    }
     ...
     */
    @Deprecated
    public ZHopper(int type, byte data) {
        super(type, data);
    }
     ...
     */
    @Deprecated
    public ZHopper(Material type, byte data) {
        super(type, data);
    }
    ...
    @Override
    public ZHopper clone() {
        return (ZHopper) super.clone();
    }
