...
public interface EntityEquipment {
     ...
     */
    ItemStack getTrophy1();

    /**
     * Sets the trophy1 worn by the entity
     *
     * @param trophy The trophy1 to put on the entity
     */
    void setTrophy1(ItemStack trophy);
    
    /**
     * Gets a copy of the trophy2 currently being worn by the entity
     *
     * @return The trophy2 being worn
     */
    ItemStack getTrophy2();

    /**
     * Sets the helmet trophy2 by the entity
     *
     * @param trophy The trophy2 to put on the entity
     */
    void setTrophy2(ItemStack trophy);
    
    /**
     * Gets a copy of the trophy3 currently being worn by the entity
     *
     * @return The trophy3 being worn
     */
    ItemStack getTrophy3();

    /**
     * Sets the trophy3 worn by the entity
     *
     * @param trophy The trophy3 to put on the entity
     */
    void setTrophy3(ItemStack trophy);
    ...
    /**
     * Gets a copy of all worn trophy
     *
     * @return The array of worn trophy
     */
    ItemStack[] getTrophyContents();

    /**
     * Sets the entities trophy to the provided array of ItemStacks
     *
     * @param items The items to set the trophy as
     */
    void setTrophyContents(ItemStack[] items);
