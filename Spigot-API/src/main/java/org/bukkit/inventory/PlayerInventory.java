...
public interface PlayerInventory extends Inventory {
    ...
    /**
     * Return the ItemStack from the trophy1 slot
     *
     * @return The ItemStack in the trophy1 slot
     */
    public ItemStack getTrophy1();
    
    /**
     * Return the ItemStack from the trophy2 slot
     *
     * @return The ItemStack in the trophy2 slot
     */
    public ItemStack getTrophy2();
    
    /**
     * Return the ItemStack from the trophy3 slot
     *
     * @return The ItemStack in the trophy3 slot
     */
    ...
    /**
     * Put the given ItemStack into the trophy1 slot. This does not check if
     * the ItemStack is a helmet
     *
     * @param trophy The ItemStack to use as trophy1
     */
    public void setTrophy1(ItemStack trophy);
    
    /**
     * Put the given ItemStack into the trophy2 slot. This does not check if
     * the ItemStack is a helmet
     *
     * @param trophy The ItemStack to use as trophy2
     */
    public void setTrophy2(ItemStack trophy);
    
    /**
     * Put the given ItemStack into the trophy3 slot. This does not check if
     * the ItemStack is a helmet
     *
     * @param trophy The ItemStack to use as trophy3
     */
    public void setTrophy3(ItemStack trophy);
