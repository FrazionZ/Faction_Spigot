 ...
 */
public class BigXpEvent extends ProjectileHitEvent {
    private static final HandlerList handlers = new HandlerList();
    private int exp;
    private boolean showEffect = true;

    public BigXpEvent(final ThrownBigXp bottle, final int exp) {
        super(bottle);
        this.exp = exp;
    }

    @Override
    public ThrownBigXp getEntity() {
        return (ThrownBigXp) entity;
    }
