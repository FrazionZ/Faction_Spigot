...
public final class Bukkit {
     ...
     * @throws IllegalArgumentException if the size is not a multiple of 9
     */
    public static Inventory createHdvInventory(InventoryHolder owner, InventoryType type) {
     ...
     * @throws IllegalArgumentException if the size is not a multiple of 9
     */
    public static Inventory createHdvInventory(InventoryHolder owner, InventoryType type, String title) {
     ...
     * @throws IllegalArgumentException if the size is not a multiple of 9
     */
    public static Inventory createHdvInventory(InventoryHolder owner, int size) throws IllegalArgumentException {
     ...
     * @throws IllegalArgumentException if the size is not a multiple of 9
     */
    public static Inventory createHdvInventory(InventoryHolder owner, int size, String title) throws IllegalArgumentException {
        return server.createHdvInventory(owner, size, title);
    }
    
    public static Inventory createSpawnerInventory(InventoryHolder owner, InventoryType type) {
     ...
     * @throws IllegalArgumentException if the size is not a multiple of 9
     */
    public static Inventory createSpawnerInventory(InventoryHolder owner, InventoryType type, String title) {
     ...
     * @throws IllegalArgumentException if the size is not a multiple of 9
     */
    public static Inventory createSpawnerInventory(InventoryHolder owner, int size) throws IllegalArgumentException {
     ...
     * @throws IllegalArgumentException if the size is not a multiple of 9
     */
    public static Inventory createSpawnerInventory(InventoryHolder owner, int size, String title) throws IllegalArgumentException {
        return server.createSpawnerInventory(owner, size, title);
    }
