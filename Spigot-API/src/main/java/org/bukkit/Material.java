...
import org.bukkit.material.DirtChest;
import org.bukkit.material.Dispenser;
import org.bukkit.material.Door;
import org.bukkit.material.Dye;
import org.bukkit.material.EnderChest;
import org.bukkit.material.FlowerPot;
import org.bukkit.material.FrazionChest;
import org.bukkit.material.FrazionFurnace;
import org.bukkit.material.Furnace;
import org.bukkit.material.Gate;
import org.bukkit.material.HdvChest;
...
import org.bukkit.material.OnyxChest;
import org.bukkit.material.OnyxFurnace;
...
import org.bukkit.material.YelliteChest;
import org.bukkit.material.YelliteFurnace;
...
public enum Material {
    ...
    GOLD_NUGGET(371),
    NETHER_STALK(372),
    POTION(373, 2, MaterialData.class),
    GLASS_BOTTLE(374),
    SPIDER_EYE(375),
    ...
    YELLITE_HELMET(1008, 1, 875), // 11
    YELLITE_CHESTPLATE(1009, 1, 1250), // 16
    YELLITE_LEGGINGS(1010, 1, 1125), // 15
    YELLITE_BOOTS(1011, 1, 1000), // 13
    YELLITE_SWORD(1012, 1, 2000),
    YELLITE_SHOVEL(1013, 1, 2000),
    YELLITE_PICKAXE(1014, 1, 2000),
    YELLITE_AXE(1015, 1, 2000),
    YELLITE_HOE(1016, 1, 2000),
    
    
    BAUXITE_HELMET(1017, 1, 1050),
    BAUXITE_CHESTPLATE(1018, 1, 1500),
    BAUXITE_LEGGINGS(1019, 1, 1350),
    BAUXITE_BOOTS(1020, 1, 1200),
    BAUXITE_SWORD(1021, 1, 2500),
    BAUXITE_SHOVEL(1022, 1, 2500),
    BAUXITE_PICKAXE(1023, 1, 2500),
    BAUXITE_AXE(1024, 1, 2500),
    BAUXITE_HOE(1025, 1, 2500),
    
    
    ONYX_HELMET(1026, 1, 1225),
    ONYX_CHESTPLATE(1027, 1, 1750),
    ONYX_LEGGINGS(1028, 1, 1575),
    ONYX_BOOTS(1029, 1, 1400),
    ONYX_SWORD(1030, 1, 3000),
    ONYX_SHOVEL(1031, 1, 3000),
    ONYX_PICKAXE(1032, 1, 3000),
    ONYX_AXE(1033, 1, 3000),
    ONYX_HOE(1034, 1, 3000),
    
    FRAZION_HELMET(1035, 1, 1575),
    FRAZION_CHESTPLATE(1036, 1, 2250),
    FRAZION_LEGGINGS(1037, 1, 2025),
    FRAZION_BOOTS(1038, 1, 1800),
    FRAZION_SWORD(1039, 1, 4000),
    FRAZION_SHOVEL(1040, 1, 4000),
    FRAZION_PICKAXE(1041, 1, 4000),
    FRAZION_AXE(1042, 1, 4000),
    FRAZION_HOE(1043, 1, 4000),
    
    ULTRA_BOW(1044, 1, 500),
    
    DIRT_CHEST(463, DirtChest.class),
    YELLITE_CHEST(464, YelliteChest.class),
    BAUXITE_CHEST(505, BauxiteChest.class),
    FRAZION_CHEST(506, FrazionChest.class),
    ONYX_CHEST(465, OnyxChest.class),
    HDV_CHEST(466, HdvChest.class),
    
    
    
    FRAZION_HAMMER(1060, 1, 1561),
    
    YELLITE_MULTITOOL(1061, 1, 2000),
    BAUXITE_MULTITOOL(1062, 1, 2500),
    ONYX_MULTITOOL(1063, 1, 3000),
    FRAZION_MULTITOOL(1064, 1, 4000),
    ...
    YELLITE_APPLE(1082, 8),
    BAUXITE_APPLE(1083, 8),
    ONYX_APPLE(1084, 8),
    FRAZION_APPLE(1085, 2),
    
    YELLITE_FURNACE(480, YelliteFurnace.class),
    LIT_YELLITE_FURNACE(481, YelliteFurnace.class),
    
    BAUXITE_FURNACE(482, BauxiteFurnace.class),
    LIT_BAUXITE_FURNACE(483, BauxiteFurnace.class),
    
    ONYX_FURNACE(484, OnyxFurnace.class),
    LIT_ONYX_FURNACE(485, OnyxFurnace.class),
    
    FRAZION_FURNACE(486, FrazionFurnace.class),
    LIT_FRAZION_FURNACE(487, FrazionFurnace.class),
    
    BAUXITE_LADDER(488, Ladder.class),
    CRIMSON_LOG(489),
    CRIMSON_ROOTS(490),
    CRIMSON_FUNGI(491),
    
    NETHER_WART_BLOCK_2(492),
    SANDSTONE_2(493),
    
    STONE_ANDESITE(494),
    STONE_ANDESITE_SMOOTH(495),
    
    STONE_GRANITE(496),
    STONE_GRANITE_SMOOTH(497),
    
    STONE_DIORITE(498),
    STONE_DIORITE_SMOOTH(499),
    
    RANDOM_ORE(500),
    
    AMELIORATOR(501, MaterialData.class),
    ...
    FRAZION_HELMET_70(1103, 1, 2275),
    FRAZION_CHESTPLATE_70(1104, 1, 3250),
    FRAZION_LEGGINGS_70(1105, 1, 2925),
    FRAZION_BOOTS_70(1106, 1, 2600),
    
    FRAZION_HELMET_100(1107, 1, 2800),
    FRAZION_CHESTPLATE_100(1108, 1, 4000),
    FRAZION_LEGGINGS_100(1109, 1, 3600),
    FRAZION_BOOTS_100(1110, 1, 3200),
    
    TRAVELERS_HELMET(1111, 1, 630),
    TRAVELERS_CHESTPLATE(1112, 1, 900),
    TRAVELERS_LEGGINGS(1113, 1, 810),
    TRAVELERS_BOOTS(1114, 1, 720),
    
    LEGENDARY_AXE(1115),
    LEGENDARY_SWORD(1116),
    LEGENDARY_DAGGER(1117),
    LEGENDARY_SCYTHE(1125),
    ...
    DYNAMITE_ARROW(1201, 64),
    
    SPAWNER_PICKAXE(1205),
    
    FRAZION_DAGGER(1206, 1, 2500),
    
    OBSIDIAN_YELLITE(474),
    OBSIDIAN_BAUXITE(475),
    OBSIDIAN_ONYX(476),
    OBSIDIAN_FRAZION(477),
    ...
    BOOSTER_XP(1214),
    BOOSTER_APTITUDE(1215),
    BOOSTER_REPAIR(1216),
    
    WITHER_BLOCK(512),
    COMPACT_COBBLESTONE_X1(513),
    COMPACT_COBBLESTONE_X2(514),
    COMPACT_COBBLESTONE_X3(515),
    COMPACT_COBBLESTONE_X4(516),
    COMPACT_COBBLESTONE_X5(517),
    
    WITHERED_BONE(1217),
    WITHERED_BONE_MEAL(1218),
    
    BOTTLEXP(1219),
    FACTION_TOKEN(1220),
    
    REVERSE_FALL_BLOCK(518),
    
    STONE_BLACKSTONE(519),
    STONE_BLACKSTONE_SMOOTH(520),
    
    BLOCK_PLACER_CHEST(521),
    BLOCK_PLACER_TRAPCHEST(522),
    
    TROPHY_FORGE(523),
    GRIMOIRE_DEPESTAL(524),
    ITEM_CRUSHER(525),

    TROPHY_BAT(1250),
    TROPHY_BLAZE(1251),
    TROPHY_CREEPER(1252),
    TROPHY_ENDERMAN(1253),
    TROPHY_GHAST(1254),
    TROPHY_GUARDIAN(1255),
    TROPHY_VILLAGER(1256),
    TROPHY_SHULKER(1257),
    TROPHY_SPIDER(1258),
    TROPHY_SKELETON(1259),
    TROPHY_SLIME(1260),
    TROPHY_SQUID(1261),
    TROPHY_PIG(1262),
    TROPHY_SHEEP(1263),
    TROPHY_IRON_GOLEM(1264),
    TROPHY_SILVERFISH(1265),

    RUNE_ANTI_MALUS(1300),
    RUNE_BONUS(1301),
    RUNE_CHANCE(1302),
    RUNE_DAMAGE(1303),
    RUNE_HEALTH(1304),
    ...
    public boolean isBlock() {
    	if( this.id < 256 || (this.id > 453 && this.id < 550)) {
    		return true;
    	}
    	else {
    		return false;
    ...
    public boolean isSolid() {
        ...
        switch (this) {
            ...
            case OBSIDIAN:
            case OBSIDIAN_YELLITE:
            case OBSIDIAN_BAUXITE:
            case OBSIDIAN_ONYX:
            case OBSIDIAN_FRAZION:
            case MOB_SPAWNER:
            case WOOD_STAIRS:
            case CHEST:
            case DIAMOND_ORE:
            ...
            case CRIMSON_LOG:
            case NETHER_WART_BLOCK_2:
            case SANDSTONE_2:
            case STONE_ANDESITE:
            case STONE_ANDESITE_SMOOTH:
            case STONE_BLACKSTONE:
            case STONE_BLACKSTONE_SMOOTH:
            case BLOCK_PLACER_CHEST:
            case BLOCK_PLACER_TRAPCHEST:
            case STONE_GRANITE:
            ...
            case AMELIORATOR:
            case WITHER_BLOCK:
            case COMPACT_COBBLESTONE_X1:
            case COMPACT_COBBLESTONE_X2:
            case COMPACT_COBBLESTONE_X3:
            case COMPACT_COBBLESTONE_X4:
            case COMPACT_COBBLESTONE_X5:
            case TROPHY_FORGE:
                return true;
            default:
                return false;
